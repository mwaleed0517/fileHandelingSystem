...
def function_calls(fFuncs):
    while True:
        ...
        if command[0] == 'mk':
            ...
            print('\tmv fileName Source Destination\tTo move file from Soucer folder to destination folder(Notice: For main folder use \'/#\' as source or destination)')
...
if __name__ == "__main__":
    function_calls(Clint_FUNCS_LAB_10.ComandsFormatng())