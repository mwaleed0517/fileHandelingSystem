...
class FileHandling:
    ...
    def delete_file(self,file_name):
        ...
        while True:
            mmap_list,current=self.get_lists_for_mmap(next_p)
            if file_name == mmap_list[0]:
                next_file_pointer = mmap_list[2]
                break
            else:
                ToBeChanged_file_pointer = current
                next_p=int(mmap_list[2])
                    
        our_desired_location=ToBeChanged_file_pointer-10
        self.lock.acquire()
    ...
    def read_file(self,file_name):
        ...
        if "#########" == desired_list[1]:
            ...
            while True:
                ...
                # if last line of data block then move to next block
